...
try {
		...
		const katalog = (teks) => {
             res = giie.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© By: Ayogi Akbar_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:fvid})
             giie.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = giie.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6289654560615-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Kw69Oel34Nd0JuluvFNVKt', "groupName": `${NamaBot}`, "footerText": "*_© By: Ayogi Akbar_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:fvid})
...
giie.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `_Halo ${pushname}_, _sorry I ᴇᴄʜᴀ seem to be_ *_offline_*\n*Keterangan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n_*Silahkan hubungi kembali ketika online*_\nterimakasih 🤗`, "𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛 : 𝚊𝚢𝚘𝚐𝚒 𝚊𝚔", [{buttonId: `${prefix}command`, buttonText: {displayText: '@ɢɪɪᴇxsᴀʟᴀ ☕︎'}, type: 1}], {quoted:fvid, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === giie.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
			       sendButMessage(from, `_Halo ${pushname}_\n_Sorry i echa seem to be_ *_offline_*\n*Off karna :* ${alasanafk}\n*Sejak dari :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n_Silahkan hubungi kembali ketika online_\n☺︎︎Terimakasih 🤗`, "𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛 : 𝚊𝚢𝚘𝚐𝚒 𝚊𝚔", [{buttonId: '${prefix}command', buttonText: {displayText: '@ɢɪɪᴇxsᴀʟᴀ ☕︎'}, type: 1}], {quoted:fvid, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
				}
						}
					}
...
${uwu}`
giie.sendMessage(from, menu, text, { quoted: fvid, thumbnail: fs.readFileSync('./gio.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://www.instagram.com/p/CUikuHyhvVp/?utm_medium=copy_link`}}})
break
case 'command':
        ptod = "6289654560615@s.whatsapp.net"
        stod = `${sender}`
...
giie.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [stod]},quoted:fvid})
break
case 'ownermenu':
menu = `𝗢𝗪𝗡𝗘𝗥 𝗙𝗘𝗔𝗧𝗨𝗥𝗘 :
☺︎︎ ${prefix}autorespon [ on/off ]
