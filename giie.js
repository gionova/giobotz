...
case 'command':
 ...
 description: `_ʜᴀʟʟᴏ ᴋᴀᴋ @${stod.split('@')[0]}_\n_sɪʟᴀʜ ᴄʟɪᴄᴋ_ *_ʟɪsᴛ ғᴇᴀᴛᴜʀᴇ_* _ᴅɪʙᴀᴡᴀʜ ᴅᴀɴ ᴘɪʟɪʜ ᴋᴇʏᴡᴏʀᴅ ʏᴀɴɢ ᴋᴀᴍᴜ ɪɴɢɪɴ ɢᴜɴᴀᴋᴀɴ_`,
 sections: [
                     {
                      "title": `𝗴𝗶𝗼𝗻𝗼𝘃𝗮𝗯𝗼𝘁𝘀𐂂 ${jmn} - ${week} - ${calender}`,
 rows: [
                          {
                              "title": "Script",
                              "rowId": ""
...
await giie.sendMessage(from, buMess, MessageType.buttonsMessage, {quoted: fvid})
break
					case 'bugpc2':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
