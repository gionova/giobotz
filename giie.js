...
giie.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `_Halo ${pushname}_, _sorry I ᴇᴄʜᴀ seem to be_ *_offline_*\n*Keterangan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n_*Silahkan hubungi kembali ketika online*_\nterimakasih 🤗`, "𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛 : 𝚊𝚢𝚘𝚐𝚒 𝚊𝚔", [{buttonId: '${prefix}command', buttonText: {displayText: '@ɢɪɪᴇxsᴀʟᴀ ☕︎'}, type: 1}], {quoted:floc, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === giie.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
			       sendButMessage(from, `_Halo ${pushname}_, _sorry I ᴇᴄʜᴀ seem to be_ *_offline_*\n*KETERANGAN :* ${alasanafk}\n*SEMENJAK :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n_*Silahkan hubungi kembali ketika online*_\nterimakasih 🤗`, "𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛 : 𝚊𝚢𝚘𝚐𝚒 𝚊𝚔", [{buttonId: '${prefix}command', buttonText: {displayText: '@ɢɪɪᴇxsᴀʟᴀ ☕︎'}, type: 1}], {quoted:floc, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
				}
						}
					}
