...
giie.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `*_Halo ${pushname}_* 🤗\n_Maaf saat ini saya (echa) sedang offline_\n❍ *Notif :* ${alasanafk}\n❍ *Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n_Pesan kamu akan di balas ketika online_\nTerimakasih 🙏`, "Developer by: Ayogi ak", [{buttonId: '${prefix}command', buttonText: {displayText: '@ɢɪɪᴇxsᴀʟᴀ ☕︎'}, type: 1}], {quoted:fvid, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
