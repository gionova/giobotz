...
giie.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `*_Halo ${pushname}_* 🤗\n_Maaf saat ini saya (echa) sedang offline_\n❍ *Notif :* ${alasanafk}\n❍ *Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n_Pesan kamu akan di balas ketika online_\nTerimakasih 🙏`, "Developer by: Ayogi ak", [{buttonId: `${prefix}giie`, buttonText: {displayText: '@giiexsala🥤'}, type: 1},{buttonId:`${prefix}status`,buttonText:{displayText:'Info🧁'},type:1},{buttonId:`${prefix}command`,buttonText:{displayText:'Feature🍬'},type:1}], {quoted:fgi, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
case 'command':
 ...
 footerText: '*Poweredby: Ayogi Ak𐂂*',
 description: `_Haloo @${stod.split('@')[0]}_\n_Silahkan Click_ *_List Feature_* _dan pilih feature yang ingin kamu gunakan_`,
 sections: [
                     {
...
await giie.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: fgi})
 ...
 anu =`_Please Click Button Dibawah !_\n\n*ON*: untuk mengaktifkan\n*OFF*: untuk menonaktifkan`
punten = [{buttonId: 'antilink on', buttonText: {displayText: 'ON ☺︎︎'}, type: 1},{buttonId: 'antilink off', buttonText: {displayText: 'OFF ☹︎'}, type: 1}]
const btnasu = {
    contentText: `${anu}`,
    footerText: '*_Poweredby: Ayogi Ak_*',
    buttons: punten,
